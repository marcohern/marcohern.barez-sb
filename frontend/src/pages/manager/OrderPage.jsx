...
import { closeTable } from '../../api/tables';
    ...
    return (
      <div>
        ...
        <div className="form-actions" style={{ marginTop: '1rem' }}>
          <button className="btn-secondary" onClick={() => navigate('/manager/shift')}>Back to Shift</button>
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <button className="btn-secondary" onClick={() => navigate('/manager/shift')}>← Back</button>
      </div>
